...
export class Dwitter extends TwitterAPI {
	...
	public get oauthFetch(): OAuth {
		return this.oauth;
	}
	public get oauth2Fetch(): OAuth2 {
		return this.oauth2;
	}
	...
	public import(data: any) {
		...
		if (typeof data.oauth === 'object') {
			this.oauth.import(data.oauth);
		}
		if (typeof data.v1_1 === 'object') {
			this.v1_1.import(data.v11);
		}
		if (typeof data.oauth2 === 'object') {
			this.oauth2.import(data.oauth2);
		}
		if (typeof data.v2 === 'object') {
			this.v2.import(data.v11);
		}
	}
}
